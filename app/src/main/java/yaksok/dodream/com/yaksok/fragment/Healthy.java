...
public class Healthy extends Fragment {
    ...
    private ListView healthy_product_list;
    public Healthy() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        healthy_product_list = (ListView)view.findViewById(R.id.healthy_menu_list);
            ...
            public void onResponse(Call<ShopVO> call, Response<ShopVO> response) {
                ...
                if(shopVO.getStatus().equals("200")){
                    for(int i = 0; i < shopVO.getResult().size(); i++){
                        if(shopVO.getResult().get(i).getProductCategoryry().equals("제품구분 : 건강기능식품")){
                            ...
                            healthy_product_list.setAdapter(shopList);
                            }
                            else{
