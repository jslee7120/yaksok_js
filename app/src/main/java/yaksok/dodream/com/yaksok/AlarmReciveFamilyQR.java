...
public class AlarmReciveFamilyQR extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.alarmrecivefamilyqr);

        bt_select = (Button)findViewById(R.id.bt_AlarmReciveFamily_Ok_qr);
        ...
        listview = (ListView) findViewById(R.id.listview_family_qr);
            ...
            public void onClick(View v) {
                ...
                for(int i=count-1; i>=0; i--) {
                    if (checkedItems.get(i)) {
                        resultIntent2.putExtra("namee"+i,items.get(i));
                        resultIntent2.putExtra("idd"+i,items_id.get(i));
